<section class="pricing-section position-relative overflow-hidden bg-dark text-white pt-120" style="background: url('assets/img/page-header-bg.svg')no-repeat center center">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10" style="z-index: 1;">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <div class="pricing-price mt-5">
                                            <h4 class="h1 fw-bold">RS 99 <span>/Month</span></h4>
                                        </div>
                                        <a href="#" class="btn btn-primary mt-3">Start 14-Days Trial</a>
                                    </div>
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        ...
                                        <div class="pricing-price mt-5">
                                            <h4 class="h1 fw-bold">RS 699 <span>/Year</span></h4>
                                        </div>
                                        <a href="#" class="btn btn-primary mt-3">Start 14-Days Trial</a>
                                    </div>
                                </div>
