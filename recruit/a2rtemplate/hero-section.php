...
<!-- Mirrored from quiety.themetags.com/hero-sections.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jul 2022 12:04:42 GMT -->
<head>
    <!--required meta tags-->
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Hero Sections - Software & IT Solutions HTML Template</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <h1 class="display-5 fw-bold">Hero Sections</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="review-info-wrap text-center rounded-custom d-flex flex-column h-100 p-lg-5 p-4">
                                <img src="assets/img/fb-logo-w.svg" width="130" alt="facebook" class="img-fluid m-auto">
                                <div class="review-info-content mt-2">
                                    <p class="mb-4">4.9 out of 5 stars maintainable disseminate parallel team effective standards communities.</p>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="review-info-wrap text-center rounded-custom d-flex flex-column h-100 p-lg-5 p-4">
                                ...
                                <div class="review-info-content mt-2">
                                    <p class="mb-4">2k+ five star reviews excellent convergence without professional methods of empowerment. </p>
                                </div>
                                <a href="client-review.html" class="link-with-icon p-0 mt-auto text-decoration-none text-warning">Read Reviews <i
                                        class="far fa-arrow-right"></i></a>
                            </div>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-xl-5 col-lg-5">
                            <div class="hero-content-wrap text-center text-xl-start text-lg-start mt-5 mt-lg-0 mt-xl-0" data-aos="fade-up">
                                ...
                                <p class="lead">Proactively coordinate quality quality vectors vis-a-vis supply chains quickly engage client.</p>
                                <div class="hero-subscribe-form-wrap pt-4 position-relative m-auto m-xl-0 d-none d-md-block d-lg-block d-xl-block">
                                    <form id="subscribe-form" name="email-form" class="hero-subscribe-form d-block d-lg-flex d-md-flex">
                                        <input type="email" class="form-control me-2" name="Email" data-name="Email" placeholder="Enter Your Email Address" id="email-address" required="">
                                        <input type="submit" value="Subscribe" data-wait="Please wait..." class="btn btn-primary mt-3 mt-lg-0 mt-md-0">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-12">
                            <ul class="customer-logos-grid text-center list-unstyled mb-0">
                                <li>
                                    <img src="assets/img/clients/client-logo-1.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-2.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-3.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-4.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="50">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-5.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="100">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-6.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="100">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-7.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="100">
                                </li>
                                <li>
                                    <img src="assets/img/clients/client-logo-8.svg" width="150" alt="clients logo" class="img-fluid customer-logo p-1 p-md-2 p-lg-3 m-auto" data-aos="fade-up" data-aos-delay="100">
                                </li>
                            </ul>
